...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    locale: "en_US",
    images: [{ url: "/images/hero-plane-journey-poster.jpg", width: 1280, height: 720, alt: "US Visa Consultant — Airliner climbing into a clear blue sky" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "US Visa Consultant | Worldwide Visa Assistance",
    description: "Expert guidance for every visa journey — visit, study, work or family, across 40+ countries.",
    images: ["/images/hero-plane-journey-poster.jpg"],
  },
...
const localBusinessJsonLd = {
  ...
  email: SITE.email,
  image: "https://usvisaconsultantpvtltd.com/images/hero-plane-journey-poster.jpg",
